...
# Optional: LLM Provider Configuration (for backend natural language processing)
# LLM_PROVIDER = "openai"  # Options: "openai", "anthropic", "dedalus"
# OPENAI_API_KEY = "your_openai_api_key"
# ANTHROPIC_API_KEY = "your_anthropic_api_key"
# DEDALUS_API_KEY = "your_dedalus_api_key"
# LLM_MODEL = "gpt-4"  # Model name (varies by provider)
```
</details>
